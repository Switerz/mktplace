...
export const scopeQualityContract = z.object({
  ...
  load_status: z.enum(["load_absent", "load_behind_daily", "load_present"]),
  ...
  measured: z.object({
    ...
    maturation_index: optNum,
    maturation_threshold: optNum,
    maturation_index_note: z.string().nullish(),
    brands_present: optNum,
    brands_expected: optNum,
    source_first_loaded_window_start: z.string().nullish(),
    source_last_loaded_window_end: z.string().nullish(),
