...
BEGIN
    ...
    SELECT
        ...
        count(*) FILTER (WHERE ((NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col23'), '') IS NOT NULL AND NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col23'), '') !~ '^-?[0-9]+(\.[0-9]+)?$') OR (NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col26'), '') IS NOT NULL AND NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col26'), '') !~ '^-?[0-9]+(\.[0-9]+)?$'))) AS c31,
...
WHERE k.key <> ALL(ARRAY['# de compradores', '# de compradores em potencial', '# de compradores existentes', '# de novos compradores', 'Cliques Por Produto', 'Data', 'Pedidos', 'Pedidos Cancelados', 'Pedidos Devolvidos / Reembolsados', 'Repetir Índice de Compras', 'Taxa de Conversão de Pedidos', 'Vendas (BRL)', 'Vendas Canceladas', 'Vendas Devolvidas / Reembolsadas', 'Vendas Sem os Descontos da Shopee', 'Vendas por Pedido', 'Visitantes']::text[]);
    ...
    SELECT
        ...
        count(*) FILTER (WHERE (f.source_filename ~ '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})' AND (NOT ((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[2]::integer BETWEEN 1 AND 12 AND (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[1]::integer BETWEEN 1 AND (CASE WHEN (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[2]::integer = 2 THEN (CASE WHEN (((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[3]::integer % 4 = 0 AND (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[3]::integer % 100 <> 0) OR (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[3]::integer % 400 = 0) THEN 29 ELSE 28 END) WHEN (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[2]::integer IN (4, 6, 9, 11) THEN 30 ELSE 31 END)) OR NOT ((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[5]::integer BETWEEN 1 AND 12 AND (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[4]::integer BETWEEN 1 AND (CASE WHEN (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[5]::integer = 2 THEN (CASE WHEN (((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[6]::integer % 4 = 0 AND (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[6]::integer % 100 <> 0) OR (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[6]::integer % 400 = 0) THEN 29 ELSE 28 END) WHEN (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[5]::integer IN (4, 6, 9, 11) THEN 30 ELSE 31 END)) OR NOT (((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[3]::integer * 10000 + (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[2]::integer * 100 + (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[1]::integer) <= ((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[6]::integer * 10000 + (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[5]::integer * 100 + (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[4]::integer))))) AS c51,
    ...
    IF c.c51 > 0 THEN RAISE EXCEPTION 'validacao pre-insert falhou -- %: % linha(s)', 'ads: período do relatório (nome do arquivo) com calendário ou ordem inválidos', c.c51; END IF;
...
SELECT
    ...
    COALESCE((CASE WHEN NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col23'), '') IS NULL THEN NULL WHEN NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col23'), '') ~ '^-?[0-9]+(\.[0-9]+)?$' THEN (NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col23'), ''))::numeric ELSE ((NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col23'), '') || 'CONTRATO_INVALIDO')::numeric) END), (CASE WHEN NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col26'), '') IS NULL THEN NULL WHEN NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col26'), '') ~ '^-?[0-9]+(\.[0-9]+)?$' THEN (NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col26'), ''))::numeric ELSE ((NULLIF(btrim(r.raw_payload ->> 'Desconto do vendedor__col26'), '') || 'CONTRATO_INVALIDO')::numeric) END)) AS seller_discount_2,
    ...
    COALESCE(NULLIF(btrim(r.raw_payload ->> 'Cidade__col58'), ''), NULLIF(btrim(r.raw_payload ->> 'Cidade__col59'), ''), NULLIF(btrim(r.raw_payload ->> 'Cidade'), '')) AS delivery_city,
...
SELECT
    ...
    r.row_sha256                             AS row_sha256,
    r.ingested_at                            AS raw_ingested_at,
    (CASE WHEN f.source_filename !~ '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})' THEN NULL ELSE make_date((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[3]::integer, (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[2]::integer, (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[1]::integer) END) AS report_period_start,
    (CASE WHEN f.source_filename !~ '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})' THEN NULL ELSE make_date((regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[6]::integer, (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[5]::integer, (regexp_match(f.source_filename, '([0-9]{2})_([0-9]{2})_([0-9]{4})-([0-9]{2})_([0-9]{2})_([0-9]{4})'))[4]::integer) END) AS report_period_end,
