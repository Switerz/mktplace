...
A automação futura será feita no **repositório corporativo do Airflow**, substituindo o Windows Task Scheduler local. A frente foi escolhida e está **pausada até o fechamento deste gate**. Nada de Airflow foi criado, configurado ou executado nesta rodada.
