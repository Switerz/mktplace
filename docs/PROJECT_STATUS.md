...
| API oficial Shopee | **PLANEJADO** | Ainda usamos exports manuais. | Criar e aprovar apps por marca no Console Shopee, mapear endpoints e iniciar integração. | Acessos, aprovação e configuração por marca. |
