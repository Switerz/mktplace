...
REGISTRY: dict[str, Rule] = {
    ...
    "shop_stats_stat_date": Rule(value=sql_rules.shop_stats_stat_date,
                                  is_invalid=semantics.shop_stats_date_is_invalid),
    # Gate SD1-2: hora cheia do layout horário ('Tempo' = DD/MM/YYYY HH:MM).
    "shop_stats_stat_hour": Rule(value=sql_rules.shop_stats_stat_hour,
                                  is_invalid=semantics.br_hour_ts_is_invalid),
